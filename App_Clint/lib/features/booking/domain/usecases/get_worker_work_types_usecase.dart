...
/// Use case for getting work types for a worker
class GetWorkerWorkTypesUseCase {
  final BookingRepository repository;

  GetWorkerWorkTypesUseCase(this.repository);

  Future<Either<Failure, List<WorkType>>> call(int workerId) async {
    try {
      final workTypes = await repository.getWorkerWorkTypes(workerId);
