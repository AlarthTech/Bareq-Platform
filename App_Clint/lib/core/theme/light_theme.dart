...
/// Light theme configuration following Material 3 design
class LightTheme {
  static ThemeData get theme {
    ...
    return baseTheme.copyWith(
      ...
      cardTheme: CardThemeData(
        ...
        elevation: 0, // Softer shadow - use border instead
      ...
      textTheme: textTheme.copyWith(
        ...
        bodySmall: textTheme.bodySmall?.copyWith(
          color: AppColors.textSecondary.withOpacity(0.8), // Meta - Regular + opacity
          fontSize: 12,
          fontWeight: FontWeight.w400, // Regular
        ),
      ),
